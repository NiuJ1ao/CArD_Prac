...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_ports { clock }]; #IO_L13P_T2_MRCC_35 Sch=sysclk
...
#set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { x }]; #IO_L9P_T1_DQS_AD3P_35 Sch=btn[3]
